...
next_word <- function(input_word, corpus, length) {
...
build_matrix <- function(words_vec, unique_words) {
...
We have seen that Mr. Clark designed the first tube used in connection with the telegraph, and that it was a single tube, operated in one direction only by vacuum, being operated only when there were messages to send. This was extended and improved by Mr. Varley, who increased the diameter of the tubes from one and one-half inches to two and one-quarter inches, and operated them in both directions, using vacuum for sending in one direction and compressed air for sending in the other. The air current was maintained in the tubes only when messages were sent.", 10)
test_a
